...
To do so, you can go to the `customWorkloadGVRs` view, you'll be able to see all your custom GVRs. You can also create, edit, delete them.

You can also describe or simulate them by pressing enter.
