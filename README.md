...
* Override option (`override: true`) replaces the built-in action bound to the same shortcut. Without this, a plugin whose shortcut collides with a built-in binding will be skipped and an error is shown in the flash bar
