...
func (p *Pod) bindKeys(aa ui.KeyActions) {
	...
	aa.Add(ui.KeyActions{
		...
		ui.KeyShiftX:   ui.NewKeyAction("Sort %CPU (REQ)", p.GetTable().SortColCmd("%CPU/R", false), false),
		ui.KeyShiftZ:   ui.NewKeyAction("Sort %MEM (REQ)", p.GetTable().SortColCmd("%MEM/R", false), false),
