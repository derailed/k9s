...
| argocd.yaml                    | Inspect and operate ArgoCD Applications: drift, conditions, history, refresh, sync, auto-sync | applications                        | Shift-D/G/H/R/Y/Z/J/B | [jq](https://stedolan.github.io/jq/), [kubectl](https://kubernetes.io/docs/tasks/tools/) |
...
| cloudnative-pg.yaml                | Manage CloudNative-PG Cluster CR(D)s                        | cluster                        | b/h/l/p/r/s/Shift-H/L/R/S     | [kubectl-cnpg](https://cloudnative-pg.io/docs/current/kubectl-plugin/)                                   |
...
| cve-scan.yaml                  | Scan the selected container's image for HIGH/CRITICAL CVEs                                | containers                          | Shift-c           | [Trivy](https://github.com/aquasecurity/trivy), [Grype](https://github.com/anchore/grype), or Docker Scout |
...
| karpenter.yaml                 | Navigate between Karpenter NodePools, their Nodes and NodeClaims                          | nodepools/nodes/nodeclaims          | Shift-N/Shift-C/Shift-P/n | [Karpenter](https://karpenter.sh)                                     |
