...
| yaml-neat.yaml                   | Copies the pure object YAML to reuse elsewhere using [kubectl-neat][kubectl-neat] & `pbcopy` on macOS | all                                 | Shift-Y     | [kubectl-neat][kubectl-neat] ⚠️ The neat project is not maintained anymore            |
