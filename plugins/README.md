...
| krr-recommendations.yaml | Prometheus-based Kubernetes Resource Recommendations | deployments/daemonsets/statefulsets | Shift-K | [KRR](https://github.com/robusta-dev/krr)                                             |
