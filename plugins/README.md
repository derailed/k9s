...
| yaml-neat.yaml                 | Copies the pure object YAML to reuse elsewhere using [kubectl-neat](5) & `pbcopy` on macOS | all                                 | Shift-Y     | [kubectl-neat](5) ⚠️ The neat project is not maintained anymore                       |
...
[5]: https://github.com/itaysk/kubectl-neat
