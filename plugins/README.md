...
| sealed-secrets.yaml            | Convert Secrets into SealedSecrets                                                        | secrets                             | Shift-s/w   | [kubeseal](https://github.com/bitnami-labs/sealed-secrets?tab=readme-ov-file#kubeseal), [kubectl](https://kubernetes.io/docs/tasks/tools/) |
